// ABOUTME: Extracts SHA-256 hashes from pip requirements.txt files (pip --require-hashes mode).
// ABOUTME: Only "name==version" pins with --hash=sha256: annotations contribute; everything else is silently ignored.
package lockfiles
