// ABOUTME: Extracts recipe revisions from Conan v0.5+ conan.lock files.
// ABOUTME: rrev is MD5 (32 hex) by default or SHA-1 (40 hex) under scm revision mode; both are weaker than BSI's SHA-512 ask but match what Conan ships.
package lockfiles
